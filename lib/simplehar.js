...
//			har = Buffer.from(har, 'base64');

			hars = simplehar.readHar(har); //har.toString());
...
simplehar.beautifyTab = function(obj, mime) {
	...
	if(mime && obj && obj.tabs && obj.tabContainers && obj.fileContent) {
		obj.tabs += '<li><a class="waterfall-tab" data-tab="parsedcontent" href="#parsedcontent">[Parsed Content]</a></li>';
